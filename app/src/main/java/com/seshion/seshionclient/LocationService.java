    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        new Thread(new Runnable(){
            public void run() {
                ...
                /* needed to have a thread inside of a service */
                Looper.prepare();
                ...
                if (ActivityCompat.checkSelfPermission(LocationService.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                    ...
                    System.out.println("you dont have location permissions");
                }

                //locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 15000, 2, (LocationListener) listener);
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 15000, 2, listener);
                Looper.loop();
            }
        }).start();
...
//
//            DashboardActivity.MethodName(intent);
//
//        }
//    };
//
